...
var BirdEntity = me.Entity.extend({
    init: function(x, y) {
        ...
        this.renderable.addAnimation("flash", [1, 2]);
    ...
    update: function(dt) {
        ...
        if (me.input.isKeyPressed('fly')) {
            // Joe S: added this so animation occurs onClick
            this.renderable.setCurrentAnimation("flash", "idle");
            me.audio.play('wing');
...
var Share = me.GUI_Object.extend({
    ...
    onClick: function(event) {
        var shareText = 'Just made ' + game.data.steps + ' steps on Get Markt! Can you beat me? Try online here!';
        var url = 'http://ellisonleao.github.io/clumsy-bird/';
        FB.ui(
            {
             method: 'feed',
             name: 'My Get Markt Score!',
...
var Tweet = me.GUI_Object.extend({
    ...
    onClick: function(event) {
        window.open('https://soundcloud.com/majorleaguewobs/sonic-green-trill-zone-trap-remix')
        return false;
    }
